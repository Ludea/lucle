    ...
    >
      <Box sx={{ maxWidth: 720 }}>
        <Chip
          ...
          icon={
            <Box component="span" sx={{
              ...
              bgcolor: 'success.main', display: 'inline-block', ml: '10px !important',
            }} />
          }
          sx={{ mb: 4, color: 'text.secondary', borderColor: 'divider', bgcolor: 'background.paper' }}
        />
        ...
        <Typography variant="body1" color="text.secondary"
          ...
          Sparus is a desktop launcher built on Rust and WebAssembly. Extend it with plugins on both frontend and backend, ship on desktop and mobile, and let players always run the right version.
        </Typography>
        ...
        <Stack direction="row" spacing={2} sx={{ justifyContent: 'center', flexWrap: 'wrap' }}>
          ...
          <Button component="a" href="#features" variant="text" color="inherit" size="large"

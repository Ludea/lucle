  ...
  return (
    <Box
      ...
      sx={{
        ...
        py: 5,
        maxWidth: layout.maxWidth, mx: 'auto',
      }}
    >
      <Stack direction="row" sx={{ justifyContent: 'space-between"', alignItems: 'center', flexWrap: 'wrap' }} gap={2}>
        <Stack direction="row" sx={{ alignItems: 'center' }} spacing={1.25}>
          <SparusIcon />
          <Typography variant="h6" fontSize={16}>Sparus</Typography>
        ...
        <Stack direction="row" spacing={3} sx={{ alignItems: 'center' }}>
          <Typography
            ...
            sx={{ textDecoration: 'none', '&:hover': { color: 'text.primary' }, transition: 'color 0.2s' }}
          >
            GitHub
          </Typography>

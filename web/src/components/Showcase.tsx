...
const SCREENS = [
  { label: 'Main launcher',  desc: 'Game library, update status, and one-click launch.',                    icon: '🎮' },
  { label: 'Plugin manager', desc: 'Browse, enable, and configure frontend & backend plugins at runtime.',  icon: '⬡' },
  { label: 'Update stream',  desc: 'Live progress fed over gRPC — patches download while you wait.',        icon: '⟳' },
];
    ...
    <Section id="showcase">
      ...
      >
        ...
        <Stack spacing={1.5} sx={{ alignItems: 'center', position: 'relative', zIndex: 1 }}>
          ...
          <Chip
            label="screenshot coming soon" size="small" variant="outlined"

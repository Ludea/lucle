...
export function buildTheme(api: ApiTheme) {
  ...
  return createTheme({
    ...
    typography: {
      ...
      ...(api.typography?.fontWeightLight
        ? { fontWeightLight: api.typography.fontWeightLight }
        : {}),
      ...(api.typography?.fontWeightRegular
        ? { fontWeightRegular: api.typography.fontWeightRegular }
        : {}),
      ...(api.typography?.fontWeightMedium
        ? { fontWeightMedium: api.typography.fontWeightMedium }
        : {}),

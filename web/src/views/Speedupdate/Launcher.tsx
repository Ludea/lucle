...
function Launcher() {
  ...
  const [disableLauncherCreation] = useState(false);
            ...
            <Grid container spacing={2}>
              ...
              <Grid size={12}>
                <TextField fullWidth required size="small" label="Update server"
                  ...
                  slotProps={{ input: { startAdornment: urlAdornment, style: { fontFamily: "JetBrains Mono, monospace" } } }} />
              </Grid>
              <Grid size={12}>
        ...
        <Grid size={{ xs: 12, md: 5 }}>
          <SectionCard>
            ...
            <Stack spacing={2.5}>
              ...
              <TextField fullWidth size="small" label="Plugin name"
              ...
              {broadcastError && (
                <Typography variant="body2" color="error">{broadcastError}</Typography>
              )}
            </Stack>

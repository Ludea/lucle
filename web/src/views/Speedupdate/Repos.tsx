    ...
    <Dialog open={open} onClose={handleClose} maxWidth="xs" fullWidth
      ...
      <DialogTitle>
        <Stack direction="row" alignItems="center" spacing={1.5}>
          ...
          <Typography variant="subtitle1" fontWeight={700}>Delete repository</Typography>
        </Stack>
      </DialogTitle>
        ...
        >
          ...
          >
            ...
            <Box sx={{ textAlign: "left" }}>
              <Typography variant="body2" fontWeight={600} lineHeight={1.2}>Game</Typography>
          ...
          >
            ...
            <Box sx={{ textAlign: "left" }}>
              <Typography variant="body2" fontWeight={600} lineHeight={1.2}>Launcher</Typography>
              <Typography variant="caption" sx={{ opacity: 0.75 }}>
          ...
          >
            ...
            <Box sx={{ textAlign: "left" }}>
              <Typography variant="body2" fontWeight={600} lineHeight={1.2}>Both</Typography>
              <Typography variant="caption" sx={{ opacity: 0.75 }}>
